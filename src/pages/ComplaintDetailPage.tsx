    ...
    return (
      <div className="flex h-96 items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs font-semibold text-slate-400">Loading grievance dossier...</p>
        </div>
      </div>
    );
  }
  ...
  if (error || !complaint) {
    return (
      <div className="space-y-4 text-center py-16">
        <div className="p-4 rounded-full bg-rose-950/60 text-rose-400 w-16 h-16 mx-auto flex items-center justify-center border border-rose-800">
          <AlertCircle className="w-8 h-8" />
        </div>
        <h2 className="text-lg font-bold text-white">Grievance Not Found</h2>
    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 pb-3 border-b border-slate-800">
        ...
        <div className="flex items-center gap-2">
          <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-950/60 border border-emerald-800 text-[11px] font-semibold text-emerald-400">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2.5 flex-wrap">
              <span className="font-mono text-sm font-bold text-civic-400 bg-civic-950/80 px-2.5 py-0.5 rounded-lg border border-civic-800">
                {complaintId}
              </span>
            ...
            <div className="flex items-center gap-4 text-xs text-slate-400 mt-2 flex-wrap">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-slate-200 font-medium">{complaint.village}</span>
                <span>•</span>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-white bg-blue-600 hover:bg-blue-500 rounded-xl transition-all shadow-lg shadow-blue-950"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-white bg-civic-600 hover:bg-civic-500 rounded-xl transition-all shadow-lg shadow-civic-950"
            >
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-6 shadow-xl space-y-4">
            <div className="flex items-center justify-between pb-2 border-b border-slate-800">
              ...
              {typeof complaint.latitude === 'number' && typeof complaint.longitude === 'number' && (
                <span className="font-mono text-xs text-civic-400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
                ...
                <div className="text-sm font-bold text-white">{complaint.village}</div>
                <div className="text-xs text-slate-400">{complaint.ward}</div>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-6 shadow-xl space-y-4">
            ...
            {complaint.assignedWorker ? (
              <div className="p-4 rounded-xl bg-blue-950/30 border border-blue-800/40 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-blue-300">Panchayat Field Staff</div>
                  </div>
                </div>

                {complaint.deadline && (
                  <div className="pt-2 border-t border-blue-900/50 flex items-center justify-between text-xs">
              ...
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-center space-y-2">
                <div className="text-xs text-slate-400">No field worker assigned yet.</div>
                <button
                  onClick={() => setIsAssignModalOpen(true)}
                  className="w-full py-2 px-3 text-xs font-bold text-blue-400 bg-blue-950/60 border border-blue-800/60 rounded-lg hover:bg-blue-900/60 transition-colors"
                >
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-6 shadow-xl space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800">
                <div className="text-xs text-slate-400">Submission Channel:</div>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-6 shadow-xl space-y-3">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full py-2.5 px-3 text-xs font-bold uppercase tracking-wider text-cyan-300 bg-cyan-950/60 border border-cyan-800/60 rounded-xl hover:bg-cyan-900 transition-colors text-left flex items-center justify-between disabled:opacity-40"
              >
              ...
              <button
                ...
                className="w-full py-2.5 px-3 text-xs font-bold uppercase tracking-wider text-emerald-300 bg-emerald-950/60 border border-emerald-800/60 rounded-xl hover:bg-emerald-900 transition-colors text-left flex items-center justify-between disabled:opacity-40"
              >
